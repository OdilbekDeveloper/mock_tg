...
def command_pay(message):
    ...
    PRICE = LabeledPrice(label="TEST Narxi",amount=5000*100)
    bot.send_invoice(message.chat.id, title="Test uchun tolov", description="15ming so'm tolov qiling", provider_token=provider_token, currency="UZS", prices=[PRICE], start_parameter="one-month-subscripyion",
